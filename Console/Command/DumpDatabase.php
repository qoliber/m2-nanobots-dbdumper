...
namespace Qoliber\DbDumper\Console\Command;

use Qoliber\DbDumper\Export\ExportModelInterface;
use Qoliber\DbDumper\Helper\Output;
...
class DumpDatabase extends Command
{
    ...
    /** @var \Qoliber\DbDumper\Helper\Output  */
    protected Output $outputHelper;

    /** @var \Qoliber\DbDumper\Export\DumpInterface  */
    protected DumpInterface $dump;

    /**
     * @param \Qoliber\DbDumper\Helper\Output $outputHelper
     * @param \Qoliber\DbDumper\Export\DumpInterface $dump
     */
