...
class TableExport implements TableExportInterface
{
    ...
    /** @var \Qoliber\DbDumper\Sql\Connection  */
    protected Connection $connection;

    /** @var \Psr\Log\LoggerInterface  */
    protected LoggerInterface $logger;

    /** @var \Qoliber\DbDumper\Helper\FileWriter */
    ...
    /** @var \Qoliber\DbDumper\Export\DataFakerInterface[]|null  */
    protected ?array $restrictedColumns = null;

    /** @var \Qoliber\DbDumper\Export\TableFilterInterface[]|null */
     ...
     * @param \Qoliber\DbDumper\Export\TableFilterInterface[]|null $tableFilters
     */
